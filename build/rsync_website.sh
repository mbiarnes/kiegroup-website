...
#   Then you should use:
#   rsync --dry-run -PaqvrltD --stats --human-readable -e "ssh -p 2222 -i $HOME/.ssh/kiegroup/id_rsa" --protocol=28 --delete-after target/website/* kiegroup@filemgmt-prod-sync.jboss.org:www_htdocs/kiegroup
